            ...
            <div class="topbar-right">
                ...
                <div class="user-profile-container">
                    <div class="user-profile">
                        <div class="user-info">
                            <span class="name">Purchase Executive</span>
                            <span class="role">Purchase Zone</span>
                        </div>
                        <div class="avatar-text">P</div>
                    </div>
                    
                    <div class="profile-dropdown" id="profileDropdown">
                        <div class="dropdown-header">
                            <img src="https://ui-avatars.com/api/?name=Purchase+Executive&background=E2E8F0&color=4361EE&size=80" alt="Purchase Executive" class="dropdown-illustration">
                            <div class="dropdown-name">Purchase Executive</div>
                            <div class="dropdown-role">Purchase Zone</div>
                        </div>
                        <div class="dropdown-body">
                            ...
                            <div class="dropdown-item">
                                <i class="ph ph-envelope"></i> purchase@inventorypro.com
                            </div>
                        </div>
