            ...
            <div class="topbar-right">
                ...
                <div class="user-profile-container">
                    <div class="user-profile">
                        <div class="user-info">
                            <span class="name">Supplier Account</span>
                            <span class="role">Verified Supplier</span>
                        </div>
                    ...
                    <div class="profile-dropdown" id="profileDropdown">
                        <div class="dropdown-header">
                            <img src="https://ui-avatars.com/api/?name=Supplier&background=E2E8F0&color=4361EE&size=80" alt="Supplier" class="dropdown-illustration">
                            <div class="dropdown-name">Supplier Account</div>
                            <div class="dropdown-role">Verified Supplier</div>
                        </div>
                        <div class="dropdown-body">
                            ...
                            <div class="dropdown-item">
                                <i class="ph ph-envelope"></i> supplier@inventorypro.com
                            </div>
                        </div>
